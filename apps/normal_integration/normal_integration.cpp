 ...
 */
void normal_integration::gatherVertexInformation(Mesh &mesh, uint vertexIndex, std::vector<int> &neighborList, std::vector<int> &neighborMap, std::vector<int> & gridNeighbors)
{
